...
@export var shield_cooldown := 7.0
@export var shield_damage_reduction := 0.8
...
func take_damage(amount: float) -> void:
	...
	if is_shielded:
		...
		print("🛡️ Shield blocked most of the damage!")
